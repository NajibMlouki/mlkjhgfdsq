...
if (!isset($_SESSION['login'])) {
 ...
 if(isset($_GET['searchAction'])&& $_GET['searchAction'] ){ 
   $_SESSION['searchAction']="True";
   $_SESSION['key_words']=$_GET['key_words']; 
 } else {
     $_SESSION['searchAction']="False";
     $_SESSION['key_words']="";
 }
?>
<!DOCTYPE HTML>
...
<script src="mapping_1.0.php" type="text/javascript"></script>
      ...
      <div class="signup">
        <div class="col-1-2" style="margin: 150px 0 40px 0;">
          ...
          <!-- onSubmit="return submitRegistrationForm1(event); return false;" -->
            <form accept-charset="UTF-8" action="#" method="get" name="newreg" >
...
<p><a href="register1.php">Inscription</a> gratuite pour les médecins vérifiées. </p>
      ...
      if(isset($_GET['searchAction'])&& $_GET['searchAction'] ){
        ...
        //$sh= new SearchMap();   
         //$res = $sh->searchMap($_GET['key_words']);
...
<?php $REPOSITORY=".."; include '..\Template\footer_tpl.php'; ?>
