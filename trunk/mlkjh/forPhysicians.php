...
<html >
<head>
<title>Doctunisie Pour les medecins</title>
      ...
      <div class="signup">
        <div class="col-1-2" style="margin: 150px 0 40px 0;">
          ...
          <!-- onSubmit="return submitRegistrationForm1(event); return false;" -->
            <form accept-charset="UTF-8" action="forPhysicians.php" method="get" name="newreg" >
               ...
               <ul>
                  <?php 
                      while($tab = mysql_fetch_assoc($sh->result3)){
                               include 'Template/search/badge_colleague_tpl.php';
                      }    
                   ?>
              </ul> 
            </div> 
